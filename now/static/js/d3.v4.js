...
function simulation(nodes) {
  ...
  function initializeNodes() {
    console.log("initializeNodes into")
  ...
  return simulation = {
    ...
    nodes: function(_) {
      ...
      return arguments.length ? (nodes = _,console.log('nodess'), console.log(nodes), initializeNodes(), forces.each(initializeForce), simulation) : nodes;
    },
